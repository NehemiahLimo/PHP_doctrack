        ...
        <aside class="left-panel">
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    ...
                    <li class="has-submenu"><a href="#"><i class="ion-flask"></i> <span class="nav-label">User Management</span></a>
                        <ul class="list-unstyled">
                            <li><a href="users">Register Users</a></li>
                            <li><a href="view_users">Registered Users</a></li>
                        </ul>
                    </li>
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <?php
                            $inbox=$conn->query("SELECT * FROM sent_documents WHERE status_id=1 AND sent_documents.receiver='$_SESSION[admin]'");
