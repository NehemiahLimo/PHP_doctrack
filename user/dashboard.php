                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="widget-panel widget-style-2 bg-pink">
                            <i class="ion-eye"></i>
                               <?php
                            $q=$conn->query("SELECT * FROM registered_documents WHERE document_by='$_SESSION[user]'");
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="widget-panel widget-style-2 bg-purple">
                            <i class="ion-paper-airplane"></i>
                                 <?php
                            $q=$conn->query("SELECT * FROM sent_documents WHERE sender='$_SESSION[user]' GROUP BY doc_id");
                            $send=$q->num_rows;
                            ?>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="widget-panel widget-style-2 bg-info">
                            <i class="ion-ios7-pricetag"></i>
                                 <?php
                            $q=$conn->query("SELECT * FROM sent_documents WHERE receiver='$_SESSION[user]' GROUP BY doc_id");
                            $receive=$q->num_rows;
                            ?>
