                            ...
                            <div class = "message">
                                <!-- Add new document -->
                                    ...
                                    if(isset($_POST['register_document'])){
                                        ...
                                        $query=$conn->query("INSERT INTO registered_documents (title,document_by,document_name,date_registered) VALUES ('$title','$_SESSION[user]','$document',NOW())") ;
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $count=1;
                                                $query = $conn->query("SELECT * FROM registered_documents WHERE document_by='$_SESSION[user]'");
                                               ;
