...
<?php require_once('../inc/sidebar_user.php');?>
          ...
          if(isset($_GET['update'])){
              $update=$conn->query("UPDATE sent_documents SET status_id=2 WHERE receiver='$_SESSION[user]'");
          }
                        ...
                        <div class="panel panel-default p-0  m-t-20">
                            <div class="panel-body p-0">
                                <div class="list-group no-border mail-list">
                                    ...
                                    AND sent_documents.receiver='$_SESSION[user]'");
                                ...
                                <table class="table table-hover mails">
                                    <tbody>
                                        ...
                                        $inbox = $conn->query("SELECT users.*, registered_documents.*, sent_documents.* FROM users, registered_documents, sent_documents WHERE users.pfnumber=sent_documents.sender AND
                                                                registered_documents.id=sent_documents.doc_id AND sent_documents.receiver='$_SESSION[user]'");
                                                                 while($result=mysqli_fetch_assoc($inbox)){
                                                            ?>
